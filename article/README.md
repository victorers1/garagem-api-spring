...
![Exemplo de erro de validação](img/cadastro_veiculo.jpg)

Exemplo de veículo inválido:
![Exemplo de erro de validação](img/veiculo_invalido.jpg)

Exemplo de veículo válido, mas usuário inexistente:
![Exemplo de erro de validação](img/cadastro_veiculo_mas_usuario_nao_existe.jpg)

Exemplo de veículo e usuário válidos, mas veículo não existe na Tabela FIPE:
